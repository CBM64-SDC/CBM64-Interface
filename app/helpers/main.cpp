...
//g++ -std=c++11 main.cpp `pkg-config --libs --cflags opencv` -o laneline
...
int main(int argc, char** argv){
    ...
    VideoWriter video("public/videos/output.mp4", CV_FOURCC('H', '2', '6', '4'), 10, Size(frame_width, frame_height), 0);
